...
import { designProcessData, keyFeaturesData } from "./mobileAppDevData";
import Accordion from "../../../../components/General/Accordion";
const MobileAppDev = () => {
  return (
    <section className=" xxl:mx-auto pt-20 relative">
      <BgframeImg URL={uiuxbg1} style="right-0 top-0" />
      <Breadcrumbs
        currentPage={[
          { URL: "..", text: "Service" },
          { URL: "", text: "Web Design and Dev" },
        ]}
      />
      <div className="px-4 md:px-16 lg:px-9 xl:px-20 space-y-12 pt-4 pb-20">
        <MainContext
          ...
          subTitle=" "
          stStyle="text-5xl"
          stOrngeText="Web Design and Development"
      ...
      <div className="bg-[#FCEAE2] px-4 md:px-16 lg:px-9 xl:px-20 py-14 ">
        <h2 className=" text-4xl font-semibold">Our Mobile App Development Process</h2>
        <ul className="">
